...
static const unsigned int start_with_borders = 1;
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_hiligh, "-sf", col_gray4, NULL };
