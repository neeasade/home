...
;; TODO: * Consider binding ^w binds to terminal multiplexer's command
...
;; I will be solving it by using a terminal multiplexer
...
;; NOTE: Don't start any command with a number.
