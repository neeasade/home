...
sys.path.insert(0, '/home/the_human/var/cache/tm/colors')
import colors
...
## Type: QtColor
c.colors.completion.category.fg = colors.color7
...
## Type: QssColor
c.colors.completion.match.fg = colors.color1
...
## Type: QssColor
c.colors.completion.scrollbar.bg = colors.color0
...
## Type: QtColor
c.colors.downloads.error.bg = colors.color0

## Foreground color for downloads with errors.
## Type: QtColor
c.colors.downloads.error.fg = colors.color1

## Color gradient start for download backgrounds.
## Type: QtColor
c.colors.downloads.start.bg = colors.color0

## Color gradient start for download text.
## Type: QtColor
c.colors.downloads.start.fg = colors.color7

## Color gradient stop for download backgrounds.
## Type: QtColor
c.colors.downloads.stop.bg = colors.color0

## Color gradient end for download text.
## Type: QtColor
c.colors.downloads.stop.fg = colors.color6
...
## for transparency.
## Type: QssColor
c.colors.hints.bg = colors.color0

## Font color for hints.
## Type: QssColor
c.colors.hints.fg = colors.color7

## Font color for the matched part of hints.
## Type: QssColor
c.colors.hints.match.fg = colors.color3

## Background color of the keyhint widget.
## Type: QssColor
c.colors.keyhint.bg = colors.color3

## Text color for the keyhint widget.
## Type: QssColor
c.colors.keyhint.fg = colors.color7

## Highlight color for keys to complete the current keychain.
## Type: QssColor
c.colors.keyhint.suffix.fg = colors.color15

## Background color of an error message.
## Type: QssColor
c.colors.messages.error.bg = colors.color0

## Border color of an error message.
## Type: QssColor
c.colors.messages.error.border = colors.color0

## Foreground color of an error message.
## Type: QssColor
c.colors.messages.error.fg = colors.color1

## Background color of an info message.
## Type: QssColor
c.colors.messages.info.bg = colors.color0

## Border color of an info message.
## Type: QssColor
c.colors.messages.info.border = colors.color0

## Foreground color of an info message.
## Type: QssColor
c.colors.messages.info.fg = colors.color7

## Background color of a warning message.
## Type: QssColor
c.colors.messages.warning.bg = colors.color0

## Border color of a warning message.
## Type: QssColor
c.colors.messages.warning.border = colors.color0

## Foreground color of a warning message.
## Type: QssColor
c.colors.messages.warning.fg = colors.color4
...
## Type: String
c.colors.prompts.border = '0px ' + colors.color0

## Foreground color for prompts.
## Type: QssColor
c.colors.prompts.fg = colors.color7

## Background color for the selected item in filename prompts.
## Type: QssColor
c.colors.prompts.selected.bg = colors.color8

## Background color of the statusbar in caret mode.
## Type: QssColor
c.colors.statusbar.caret.bg = colors.color0
...
## Type: QssColor
c.colors.statusbar.caret.selection.bg = colors.color0

## Foreground color of the statusbar in caret mode with a selection.
## Type: QssColor
c.colors.statusbar.caret.selection.fg = colors.color13
...
## Type: QssColor
c.colors.statusbar.insert.bg = colors.color0

## Foreground color of the statusbar in insert mode.
## Type: QssColor
c.colors.statusbar.insert.fg = colors.color2
...
## Type: QssColor
c.colors.statusbar.passthrough.bg = colors.color0

## Foreground color of the statusbar in passthrough mode.
## Type: QssColor
c.colors.statusbar.passthrough.fg = colors.color4
...
## Type: QssColor
c.colors.statusbar.progress.bg = colors.color0
...
## (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = colors.color7
...
## Type: QtColor
c.colors.tabs.bar.bg = colors.color8
...
## Type: QtColor
c.colors.tabs.selected.even.fg = colors.color7
...
## Type: QtColor
c.colors.tabs.selected.odd.fg = colors.color7

## Background color for webpages if unset (or empty to use the theme's
## color).
## Type: QtColor
#c.colors.webpage.bg = colors.color0
...
## default is used.
## Type: Directory
c.downloads.location.directory = getenv("XDG_DOWNLOADS_HOME")
...
## Type: Font
c.fonts.downloads = '8pt ShureTechMono Nerd Font Mono'
...
## Type: Font
c.fonts.messages.error = '10pt ShureTechMono Nerd Font Mono'

## Font used for info messages.
## Type: Font
c.fonts.messages.info = '10pt ShureTechMono Nerd Font Mono'

## Font used for warning messages.
## Type: Font
c.fonts.messages.warning = '10pt ShureTechMono Nerd Font Mono'

## Default monospace fonts. Whenever "monospace" is used in a font
## setting, it's replaced with the fonts listed here.
## Type: Font
c.fonts.monospace = '"xos4 Terminus", Terminus, terminus, "IBM Plex Mono"'
...
## Type: String
c.hints.border = '0px solid ' + colors.color0

## Characters used for hint strings.
## Type: UniqueCharString
c.hints.chars = 'asdftyuio'
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'file:///home/the_human/var/cache/homepage.html'
...
c.url.start_pages = ['file:///home/the_human/var/cache/homepage.html']
