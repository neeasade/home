...
hi Include      ctermbg=NONE   ctermfg=7   cterm=NONE
...
hi SpecialChar  ctermbg=NONE   ctermfg=15  cterm=NONE
hi Delimiter    ctermbg=NONE   ctermfg=7   cterm=NONE
hi Underliend   ctermbg=NONE   ctermfg=7   cterm=underline
hi Ignore       ctermbg=NONE   ctermfg=7   cterm=NONE
hi Error        ctermbg=NONE   ctermfg=7   cterm=bold
