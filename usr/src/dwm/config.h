...
/*  { MODKEY,                       XK_t,      setlayout,      {.v = &layouts[0]} },
    ...
    { SUPERKEY,                     XK_1,      setlayout,      {.v = &layouts[0]} },
    { SUPERKEY,                     XK_5,      setlayout,      {.v = &layouts[1]} },
    { SUPERKEY,                     XK_3,      setlayout,      {.v = &layouts[2]} },
    { SUPERKEY,                     XK_2,      setlayout,      {.v = &layouts[3]} },
    { SUPERKEY,                     XK_4,      setlayout,      {.v = &layouts[4]} },
